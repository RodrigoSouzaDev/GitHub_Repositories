package com.example.github_repositories.presentation
...
import com.example.github_repositories.domain.ListUserRepositoriesUseCase
...
class RepoListFragViewModel(private val listUserRepoUseCase: ListUserRepositoriesUseCase
) : ViewModel() {
    ...
    fun getRepoList(user: String)
    {
        viewModelScope.launch (Dispatchers.IO){
            listUserRepoUseCase.execute(user)
                .onStart {
